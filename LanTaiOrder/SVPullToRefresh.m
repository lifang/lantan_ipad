...
- (id)initWithScrollView:(UIScrollView *)scrollView {
    ...
    self.titleLabel = [[[UILabel alloc] initWithFrame:CGRectMake(ceil(self.superview.bounds.size.width*0.21+10), 20, 180, 20)]autorelease];
    titleLabel.text = NSLocalizedString(@"拖曳以更新...",);
    titleLabel.font = [UIFont boldSystemFontOfSize:12];
    titleLabel.backgroundColor = [UIColor clearColor];
    [self addSubview:titleLabel];
    
    self.lastUpdatedLabel = [[[UILabel alloc] initWithFrame:CGRectMake(ceil(self.superview.bounds.size.width*0.21-6), 40, 180, 20)]autorelease];
